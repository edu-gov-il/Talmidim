...
{
    public class TalmidKesher
    {
        public int SUG_ZEHUT_TALMID { get; set; }
        public int MISPAR_ZEHUT_TALMID { get; set; }
        public int SEMEL_MOSAD_TALMID { get; set; }
        public int CODE_YEUD_KTV_NOSAF_TAL { get; set; }
        public int SEMEL_YISHUV_NOSAF_TAL { get; set; }
        public int SEMEL_RECHOV_NOSAF_TAL { get; set; }
        public string TEUR_KTOVET_NOSAF_TAL { get; set; }
        public int MISPAR_BAYIT_NOSAF_TAL { get; set; }
        public string KNISA_NOSAF_TAL { get; set; }
        public int MISPAR_DIRA_NOSAF_TAL { get; set; }
        public int MIKUD_NOSAF_TAL { get; set; }
